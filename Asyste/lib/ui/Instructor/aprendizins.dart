...
class Aprendizins extends StatefulWidget {
  @override
  
  _AprendizinsState createState() => _AprendizinsState();
}

class _AprendizinsState extends State<Aprendizins> {
    List<Widget> paginas = [
    Programa(),
    Ficha(),
  ];
        ...
        FlatButton(
            onPressed: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => Asistenciains()));
            },
            child: Column(
              children: [
                Row(
                  children: [
                    Container(
                        width: 80,
                        child: Image.asset("assets/icon/dia.png")),
                    Column(
              ...
              children: [
                Row(
                  children: [
                    Container(
                        width: 80,
                        child: Image.asset("assets/icon/co.png")),
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
              ...
              children: [
                Row(
                  children: [
                    Container(
                        width: 80,
                        child: Image.asset("assets/icon/bie.png")),
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
